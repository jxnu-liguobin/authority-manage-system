...
import cn.edu.jxnu.base.shiro.MyRealm;
...
public class WebLogAspect {
  ...
  /**
   * 使用@Pointcut定义一个切入点，可以是一个规则表达式，比如下例中某个package下的所有函数，也可以是一个注解等。 public表示访问权限是公有方法，第一个*表示返回类型，第二
   * *表示类名，第三个*表示方法(..)表示任何参数，包含子包
   */
  ...
  /** 定义授权修改使用的切点 */
  @Pointcut(
      "execution(public * cn.edu.jxnu.base.controller.admin.system.UserController.grantRole(..))")
