 ...
 *
 * <p>This is more restrictive than the {@link UserTag}, which only ensures the current user is
 * known to the system, either via a current login or from Remember Me services, which only makes
 * the assumption that the current user is who they say they are, and does not guarantee it like
 * this tag does.
 *
 * <p>The logically opposite tag of this one is the {@link NotAuthenticatedTag}
 *
 * <p>Equivalent to {@link org.apache.shiro.web.tags.AuthenticatedTag}
 *
 * @since 0.2
 */
